...
\lstinputlisting[language=risc-v, style=printing, caption={This code simply checks a loop condition based on some previous computations, a very common pattern.}, captionpos=b]{diagrams/trace_assisted_caching/justification.S}
...
% TODO Add diagram showing current situation, marking where the effective address appears
...
% TODO Add diagram showing ideal situation 
