...
\begin{figure}
	...
	\caption[Memory Hierarchy]{The pyramid shows an example memory hierarchy for a desktop computer where height indicates both cost and speed of access. The decreasing size of each pyramid step also shows the capacity of each type of memory present in the system.}
	\label{fig:hierarchy}
\end{figure}
