\begin{tikzpicture}
     	...
     	\draw [thick] [->] ([xshift=-1em]cache.south) -- ([xshift=-1em]main-memory.north) node[midway, left] {\textbf{\texttt{0x2524FF6A}}};
     	\draw [thick] [->] ([xshift=1em]main-memory.north) -- ([xshift=1em]cache.south) node[midway, right] {\textbf{\texttt{0xAABBCCDD}}};
\end{tikzpicture}