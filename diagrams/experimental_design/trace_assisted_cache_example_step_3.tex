...
\begin{center}
	...
	\draw [->, thick] ([xshift=-1.3cm]trace-repo.south) node [right, yshift=-0.55cm] {\textcolor{gray!40}{\textbf{(\texttt{0xFEC42783}, \texttt{0xFEEC})}}} |-  ([yshift=0.5cm]tac-controller.west);
	\draw [->, thick] ([xshift=-1.3cm]cpu.north) node [right, yshift=0.55cm] {\textcolor{black}{\textbf{(\texttt{0xFEFC}, \texttt{0x1122AABB})}}} |-  ([yshift=-0.5cm]tac-controller.west);
